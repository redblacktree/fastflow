...
#### Automated Verification:
- [x] Code compiles: `go build ./...`
- [x] Help text shows new flag: `go run ./cmd/fastflow run --help`
...
#### Automated Verification:
- [x] Code compiles: `go build ./...`
- [x] Binary runs: `go run ./cmd/fastflow version`
- [x] Help shows resume flag: `go run ./cmd/fastflow run --help | grep resume`
